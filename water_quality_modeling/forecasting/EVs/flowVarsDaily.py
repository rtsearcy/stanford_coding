...
# Inputs #
sd = '2008-01-01'  # YYYY-MM-DD format, include one day previous
ed = '2018-10-31'
outfolder = '/Users/rtsearcy/Documents/Stanford/Projects/WQ Forecasting/data/streamflow'
...
for key in stations:
    ...
    # Change in Flow
    df_vars['dflow12'] = df_vars['logflow1'] - df_vars['logflow2']
    df_vars['dflow13'] = df_vars['logflow1'] - df_vars['logflow3']
