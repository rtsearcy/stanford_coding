...
path = '/Users/rtsearcy/Documents/Stanford/Projects/WQ Forecasting/raw data/tides/raw'
...
for key in stations_dict:
    ...
    save_file = os.path.join(path,station_name.replace(' ', '_') + '_Tide_Predictions_' + begin_date.strftime('%Y%m%d') + '_' \
