...
# Inputs #
outfolder_vars = '/Users/rtsearcy/Documents/Stanford/Projects/WQ Forecasting/data/waves/'
outfolder_raw = os.path.join(outfolder_vars,'raw')
sd = '20080101'  # start date, Must be YYYYMMDD format
ed = '20191031'  # end date, Because UTC time, include extra day
