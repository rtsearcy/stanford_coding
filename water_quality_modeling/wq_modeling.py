...
Description: Package of functions to creates a nowcast model from 
FIB and environmental data. Functions include:
    - Load modeling datasets
    - Parse data into training and test subsets
    - Fit model on training set
    TODO - add more model types
    TODO - add tuning function
    TODO - add testing function
    TODO - missing data - impute or delete columns/rows
...
def load_data(file, years=[1991], season='a'):
    ...
    - Prints FIB statistics in the dataset
        ...
        - file = full file path with modeling dataset. MUST:
                - BE A .CSV FILE
                - Contains a datetime column named 'dt'
